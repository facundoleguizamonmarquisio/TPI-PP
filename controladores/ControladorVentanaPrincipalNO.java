...
public class ControladorVentanaPrincipalNO implements java.awt.event.ActionListener {
    private VentanaPrincipalNO vista;
    private ArrayList<Cuenta> cuentas;

    public ControladorVentanaPrincipalNO(VentanaPrincipalNO vista, ArrayList<Cuenta> cuentas) {
        this.vista = vista;
