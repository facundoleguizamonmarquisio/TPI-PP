...
// sb.append("Cédula:
// ").append(cuenta.getUsuario().getDocumento()).append("\n");
// sb.append("Teléfono:
// ").append(cuenta.getUsuario().getTelefono()).append("\n\n");
...
// ").append(vehiculo.getFechaRegistro()).append("\n");
// sb.append("Hora de registro:
// ").append(vehiculo.getHoraRegistro()).append("\n");
// sb.append("=============================================\n");
// return sb.toString();
// }
// }
